              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Price alerts and trading notifications</p>
                  </div>
                  <Switch
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  <Button variant="outline">{user?.twoFactorEnabled ? "Disable" : "Enable"}</Button>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Create and manage API keys</p>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">View your API rate limits</p>
                  </div>
